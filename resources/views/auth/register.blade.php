              ...
              <div class="row d-flex justify-content-center align-items-center">
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                  <div class="card p-4 mx-auto text-center" style="border-radius: 1rem;">
                    <div class="card-body">
                        <div class="pb-4">
                            <h2 class="orange text-center">Sign Up Here</h2>
                        </div>
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group mb-3">
                                <input type="text" name="name" value="{{ old('name') }}" required placeholder="Username" class="form-control">
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-4">
                                <input type="password" name="password_confirmation" required placeholder="Confirm Your Password" class="form-control">
                            </div>
                                <!-- <p class="small mb-3 pb-lg-2 "><a class="-50 text-danger" href="#!">Forgot password?</a></p> -->
                
                                <button class="btn btn-success btn-md px-5 text-white" type="submit">Register</button>
                                <div>
