    ...
    <div class="row px-2 px-md-0 ">
        <div class="col-lg-8 bg-white align-self-start ">
                ...
                @if ($errors->has('amount'))
                                ...
                                @endif
                {{-- hidden inputes --}}
                <input type="hidden" class="form-control" name="amount" value="{{ $PackageCategoryData->price }}">
                <input type="hidden" class="form-control" name="service_id" value="{{ $PackageCategoryData->id }}">
                <input type="hidden" name="orderTypw" value="package">
                ...
                <div class="border">
                    ...
                    <div class="p-3 border-bottom">
                        <div class="d-md-flex gap-5 align-items-center">
                            <div>
                                <div class="d-flex align-items-center gap-2"  data-bs-toggle="collapse" data-bs-target="#cardCredit">
                    ...
                    <div class="p-3 ">
                        <div class="form-check" data-bs-toggle="collapse" data-bs-target="#demo">
                ...
                <div class=" pt-3 ">
                    ...
                    <div class="">
                        <div class="px-3 d-flex gap-2 align-items-center bg-white py-2 border-bottom">
                            <a href="#" class="a-link"><span>{{ $PackageCategoryData->cat_name }}</span></a> 
                        </div> 
                            <div class="px-3 pt-3 bg-white">
                                <div class="align-items-center">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="fw-bold" style="font-size: 16px;">Total</p>
                                        <p class="fw-bold" style="font-size: 16px;">${{ $PackageCategoryData->price }}</p>
                                    </div> 
                                    <div class="d-grid ">
                                        <div>
