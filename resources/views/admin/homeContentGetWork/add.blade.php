      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary"> 
            <!-- form start -->
            <form action="{{ route('homeContentGetWork.store') }}" method="POST">
                @csrf
                @if ($errors->any())
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="title" id="title" placeholder="Enter Title Name">
                </div> 
              </div>
              <div class="card-body">
                <div class="form-group">
